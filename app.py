...
def analisar_partida():
    ...
    # Simulação do palpite da IA
    palpite_ia = {
        "vencedor": time_casa if dados_casa["ultimos_10_jogos"][0]["placar_casa"] > dados_fora["ultimos_10_jogos"][0]["placar_casa"] else time_fora,
        "probabilidade": 0.65,
        "justificativa": "Baseado na simulação de chutes a gol e posse de bola."
    }
